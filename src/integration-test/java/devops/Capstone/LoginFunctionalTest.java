...
public class LoginFunctionalTest {
	...
	public void loginSuccess() {
        driver.get("http://localhost:6080/TheVaccineStore");
	...
	public void registrationSuccess() {
        driver.get("http://localhost:6080/TheVaccineStore/register.jsp");
        ...
        button.click();
        assertTrue(driver.getPageSource().contains("TheVaccineStore"));
	}
	
	@Test
	public void forgotPasswordSuccess() {
        driver.get("http://localhost:6080/TheVaccineStore/forgotpassword.jsp");      
